...
const Header = () => {
  return (
    <header
      id="header"
      className="text-white bg-dark text-center lg:text-right flex md:block lg:flex justify-between items-center border-b-2 border-white py-4 md:py-8-md lg:py-5-lg xl:py-5-xl"
    >
